...
namespace dae
{
	...
	public:
		...
		ButtonComponent(const std::string& sceneName, GameMode gameMode): m_SceneName(sceneName), m_GameMode(gameMode), m_OverlappingPlayer(false) {};
		...
		void SetOverlapping(bool overlapping) { m_OverlappingPlayer = overlapping; }
	private:
		std::string m_SceneName;
		GameMode m_GameMode;
		bool m_OverlappingPlayer;
	};
}
